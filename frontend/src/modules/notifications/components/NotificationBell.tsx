...
export const NotificationBell: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {open && (
        <div className="absolute right-0 mt-2 w-80 max-w-xs bg-white dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg z-50 notification-dropdown">
          <div className="p-3 border-b border-gray-100 dark:border-slate-700 font-semibold text-gray-900 dark:text-white">Notifications</div>
            ...
            {items.length === 0 && !loading ? (
              ...
              <>
                {items.map((n: Notification) => (
                  <div key={n._id} className="p-3 text-sm text-gray-800 dark:text-gray-200">
